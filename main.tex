...
\Title{用于高计数率束流能损测量的气氙闪烁体探测器}{ Gas Xenon Scintillator Detector for High Count Rate Beam Energy Loss Measurement}
...
\Degree{Master of Science in Nuclear Physics}
...
% 导师信息-{中文名}{英文名}{职称}
\Tutor{孙保华}{Baohua Sun}{教授}
%\Cotutor{副导师姓名}{Cotutor}{研究员}

% 学生姓名-{中文名}{英文名}
\Author{李志强}{Zhijiang Li}
% 学生学号
\StudentID{ID123456}
% 专项计划，如无则删除
...
% 时间节点-{月}{日}{年}
\DateEnroll{09}{01}{2023}
\DateGraduate{03}{31}{2026}
\DateSubmit{4}{27}{2026}
\DateDefence{5}{27}{2026}

%%=================================================================
% 摘要-{中文}{英文}
\Abstract{%
 在进行电荷改变截面测量等相关放射性束流实验时，需要高精度，耐辐照的探测器来进行能损，时间等信息的探测。当束流强度达到$10^{4}$cps以上后 ,传统的气体电离室因其较低的时间精度，在获取信号时会出现大量的堆叠事件（pile-up）影响实验数据的质量。因此，为了满足高计数率束流能损测量的需求，本文设计并开发了一种基于气氙闪烁体的探测器。该探测器利用氙气在受到辐射时产生的闪烁光信号，通过光电倍增管进行信号放大和处理，从而实现对束流能损的高精度测量。本文详细介绍了探测器的设计原理、制造工艺以及性能测试结果，验证了其在高计数率环境下的优越性能，为未来相关实验提供了有力的技术支持。
  }{
...
% 关键字-{中文}{英文}
\Keyword{束流探测器;气氙闪烁体;时间分辨}{BeiHang, Degree thesis, PhD, Master, Chinese, \LaTeX{} template, \BUAAThesis{}}
